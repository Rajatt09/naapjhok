		...
		<div className="min-h-screen flex bg-brand-cream">
			...
			<div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
				...
				<div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent flex flex-col justify-end p-16 text-white">
					...
					<p className="text-brand-cream/80 text-lg max-w-md font-light">
						Experience the seamless blend of tradition and modernity
						with our bespoke tailoring services.
					</p>
				</div>
			</div>
			...
			<div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 relative">
				...
				<div className="w-full max-w-md space-y-8 relative z-10">
					<div className="text-center lg:text-left">
						<h2 className="text-4xl font-serif text-brand-espresso mb-2">
							Welcome Back !!
						</h2>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div className="flex items-center justify-between text-sm">
							<label className="flex items-center gap-2 cursor-pointer text-brand-taupe hover:text-brand-coffee transition-colors">
								<input
									type="checkbox"
									className="rounded border-brand-brown/30 text-brand-coffee focus:ring-brand-coffee"
								/>
								<span>Remember me</span>
							</label>
							<a
								href="#"
								className="font-medium text-brand-rust hover:text-brand-brown transition-colors"
							>
								Forgot password?
							</a>
						</div>
					...
					<div className="text-center text-sm text-brand-taupe pt-4">
						...
						<Link
							to="/signup"
							className="font-bold text-brand-coffee hover:text-brand-rust ml-1 transition-colors"
						>
							Create Account
						</Link>
					</div>
